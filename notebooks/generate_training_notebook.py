...
def generate_notebook():
    ...
    cells.append({
        ...
        "source": [
            ...
            "try:\n",
            "    # Update progress\n",
            "    update_progress('training', message='Step 1/3: Training models', eta_hours=8)\n",
            "    \n",
            "    # === Step 1: Train Models (8-10 hours) ===\n",
            "    print('\\n' + '='*60)\n",
            "    print('📊 Step 1/3: Training Models')\n",
            "    print('='*60)\n",
            "    \n",
            ...
            "        --models-dir ./models\n",
            "    \n",
            "    update_progress('training', message='Step 2/3: OOD evaluation', eta_hours=0.5)\n",
            "    \n",
            "    # === Step 2: OOD Evaluation (30 min) ===\n",
            "    print('\\n' + '='*60)\n",
            "    print('📊 Step 2/3: OOD Generalization Testing')\n",
            "    print('='*60)\n",
            "    \n",
            "    !python3 training/eval.py --ood-test\n",
            "    \n",
            "    update_progress('training', message='Step 3/3: Generating figures', eta_hours=0.1)\n",
            "    \n",
            "    # === Step 3: Generate Results (5 min) ===\n",
            "    print('\\n' + '='*60)\n",
            "    print('📊 Step 3/3: Generating Tables and Figures')\n",
            "    print('='*60)\n",
            "    \n",
